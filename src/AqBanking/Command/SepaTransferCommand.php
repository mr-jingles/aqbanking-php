 ...
 */
public function execute(string $rname, string $riban, string $value, string $purpose)
{
    $shellCommand = $this->getShellCommand($rname, $riban, $value, $purpose);
 ...
 * @return string
 */
private function getShellCommand(string $rname, string $riban, string $value, string $purpose)
{
    return $shellCommand =
